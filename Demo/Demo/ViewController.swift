...
class ViewController: UITableViewController {
    ...
    func downloadRepositories(username: String) {
        GitHubProvider.request(.UserRepositories(username), completion: { (object, status, resonse, error) -> () in
    ...
    func downloadZen() {
        GitHubProvider.request(.Zen, completion: { (object, status, response, error) -> () in
